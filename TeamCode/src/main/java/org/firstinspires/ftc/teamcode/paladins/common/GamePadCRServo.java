 ...
 */
public class GamePadCRServo extends PaladinsComponent {
     ...
     * @param reverseControl {@link ButtonControl}
     * @param power          power to apply when using gamepad buttons
     * @param showTelemetry  display the power values on the telemetry
     */
    public GamePadCRServo(PaladinsOpMode opMode, Gamepad gamepad, CRServo crservo,
