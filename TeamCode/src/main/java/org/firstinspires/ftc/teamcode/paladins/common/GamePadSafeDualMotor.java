 ...
 */
public class GamePadSafeDualMotor extends PaladinsComponent {
     ...
     */
    public GamePadSafeDualMotor(PaladinsOpMode opMode, Gamepad gamepad, DcMotor motor1, DcMotor motor2,
