 ...
 */
public class GamePadSafeDualMotorwinch extends PaladinsComponent {
     ...
     */
    public GamePadSafeDualMotorwinch(PaladinsOpMode opMode, Gamepad gamepad, DcMotor motor1, DcMotor motor2,
