...
public class GamePadTankDrive extends PaladinsComponent {
    ...
    public GamePadTankDrive(PaladinsOpMode opMode, Gamepad gamepad, DcMotor leftMotor, DcMotor rightMotor) {
        super(opMode);
