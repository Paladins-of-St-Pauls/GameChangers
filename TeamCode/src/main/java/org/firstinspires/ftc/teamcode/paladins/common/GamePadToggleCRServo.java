 ...
 */
public class GamePadToggleCRServo extends PaladinsComponent {
     ...
     * @param crservo       DcMotor to operate on
     ...
     */
    public GamePadToggleCRServo(PaladinsOpMode opMode, Gamepad gamepad, CRServo crservo, ButtonControl buttonControl, float power, boolean showTelemetry) {
        super(opMode);
    ...
    public GamePadToggleCRServo(PaladinsOpMode opMode, Gamepad gamepad, CRServo crservo, ButtonControl buttonControl, float power) {
