 ...
 */
public class GamePadToggleMotor extends PaladinsComponent {
     ...
     */
    public GamePadToggleMotor(PaladinsOpMode opMode, Gamepad gamepad, DcMotor motor, ButtonControl buttonControl, float power, boolean showTelemetry) {
        super(opMode);
    ...
    public GamePadToggleMotor(PaladinsOpMode opMode, Gamepad gamepad, DcMotor motor, ButtonControl buttonControl, float power) {
