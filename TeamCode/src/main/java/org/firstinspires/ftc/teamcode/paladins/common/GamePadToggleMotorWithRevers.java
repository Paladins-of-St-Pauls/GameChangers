 ...
 */
public class GamePadToggleMotorWithRevers extends PaladinsComponent {
     ...
     */
    public GamePadToggleMotorWithRevers(PaladinsOpMode opMode, Gamepad gamepad, DcMotor motor, ButtonControl buttonControl, ButtonControl buttonControl2, float power, boolean showTelemetry) {
        super(opMode);
    ...
    public GamePadToggleMotorWithRevers(PaladinsOpMode opMode, Gamepad gamepad, DcMotor motor, ButtonControl buttonControl, ButtonControl buttonControl2, float power) {
