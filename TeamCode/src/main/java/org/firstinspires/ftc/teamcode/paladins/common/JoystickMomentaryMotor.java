 ...
 */
public class JoystickMomentaryMotor extends PaladinsComponent {
     ...
     */
    public JoystickMomentaryMotor(PaladinsOpMode opMode, Gamepad gamepad, DcMotor motor, ButtonControl buttonControl, float power, JoystickControl joystickControl, boolean showTelemetry) {
        super(opMode);
    ...
    public JoystickMomentaryMotor(PaladinsOpMode opMode, Gamepad gamepad, DcMotor motor, ButtonControl buttonControl, float power, JoystickControl joystickControl) {
