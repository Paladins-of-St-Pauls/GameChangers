 ...
 */
public class KanaloaBallSorter extends PaladinsComponent {
     ...
     */
    public KanaloaBallSorter(PaladinsOpMode opMode, ColorSensor colorSensor, Servo servo, boolean showTelemetry) {
        super(opMode);
    ...
    public KanaloaBallSorter(PaladinsOpMode opMode, ColorSensor colorSensor, Servo servo) {
