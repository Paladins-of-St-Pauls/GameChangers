 ...
 */
public class WhileGamePadCRServo extends PaladinsComponent {
     ...
     * @param crservo       CRServo to operate on
     ...
     */
    public WhileGamePadCRServo(PaladinsOpMode opMode, Gamepad gamepad, CRServo crservo, ButtonControl buttonControl, float power, boolean showTelemetry) {
        super(opMode);
    ...
    public WhileGamePadCRServo(PaladinsOpMode opMode, Gamepad gamepad, CRServo crservo, ButtonControl buttonControl, float power) {
