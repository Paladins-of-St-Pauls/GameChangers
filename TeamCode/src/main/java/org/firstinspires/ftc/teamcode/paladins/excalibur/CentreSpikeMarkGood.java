...
@Autonomous(name = "MattTEST")
public class CentreSpikeMarkGood extends PaladinsOpMode {
    ...
    protected void onInit() {
        ...
        tasks.add(new ExcaliburDriveTask(this, 0.47, drive, 0.5,0.5,0.5,0.5));
        tasks.add(new WaitTask(this,3));
        tasks.add(new ExcaliburUtilsTask(this, -1, utils, 0.5, 0,0,0));
