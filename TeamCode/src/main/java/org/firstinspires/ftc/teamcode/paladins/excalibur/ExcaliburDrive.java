...
public class ExcaliburDrive extends PaladinsComponent {
    ...
    public ExcaliburDrive(PaladinsOpMode opMode, DcMotor backLeftMotor, DcMotor backRightMotor, DcMotor frontLeftMotor, DcMotor frontRightMotor) {
        super(opMode);
