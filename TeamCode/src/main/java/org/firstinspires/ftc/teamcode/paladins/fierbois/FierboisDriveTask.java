...
public class FierboisDriveTask extends BaseTask implements Task {

    private final DurandalDrive drive;
    private final double leftSpeed;
    private final double rightSpeed;

    public FierboisDriveTask(PaladinsOpMode opMode, double time, DurandalDrive drive, double leftSpeed, double rightSpeed) {
        super(opMode, time);
        this.drive = drive;
