...
@Autonomous(name = "JoyeuseAutoTestAlt")
public class JoyeuseAutoTestAlt extends PaladinsOpMode {
    ...
    protected void onInit() {
        ...
        tasks.add(new StackChoiceTask(this, 2.0, new Point(0, 0), tasks, tasks_none_rings, tasks_one_ring, tasks_four_rings));
    }
