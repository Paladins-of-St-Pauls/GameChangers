...
public class JoyeuseTriggerSteerDrive extends PaladinsComponent {
    ...
    public JoyeuseTriggerSteerDrive(PaladinsOpMode opMode, Gamepad gamepad, JoyeuseDrive drive) {
        super(opMode);
this.drive = drive;
...
//        float scalePower = scaleTriggerPower(gamepad.left_trigger - gamepad.right_trigger);
        ...
        if (gamepad.left_trigger > 0) {
            scalePower = scaleTriggerPower(gamepad.left_trigger);
        }
        ...
        if (gamepad.right_trigger > 0) {
            scalePower = scaleTriggerPower(-gamepad.right_trigger);
        }
